    ...
    <main class="main">
        <div class="main-slider">
            <div class="container">
                ...
                <a href="/catalog?>PROPERTY_DISCOUNT_PERCENT=0" target="_blank" class="button main-slider__button"
                   type="submit">Shop sale</a>
                <a href="/catalog?PROPERTY_SEX=male" target="_blank" class="button button_solid" type="submit">Shop the
                    menswear</a>
            </div>
        </div>
        <section>
            ...
            <div class="wide-container">
                <div class="new-arrivals">
                    <div class="new-arrivals__text">
                        ...
                        <a class="new-arrivals__small-text" href="#"
                           target="_blank"><span>See the collection here</span></a>
                    </div>
                    <?
                    $APPLICATION->IncludeComponent(
                        "bitrix:news.list",
                    ...
                    <div class="blog">
                        <div class="blog__card">
                            ...
                            <div class="blog__card__text">
                                ...
                                <p class="icon-box__text_small">Ipsum aliquet nisi, hendrerit rhoncus quam tortor,
                                    maecenas faucibus. Tincidunt aliquet sit vel, venenatis nulla. Integer bibendum
                                    turpis convallis...</p>
                            </div>
                        </div>
                        <div class="blog__card">
                            ...
                            <div class="blog__card__text">
                                <p class="icon-box__text icon-box__text_green">Top 10 of This Season’s Hottest
                                    Sneakers</p>
                                <div class="meta">
                                    <p>Lifestyle</p>
                                    <p>July 16, 2020</p>
                                ...
                                <p class="icon-box__text_small">Porta habitant vitae quam interdum. Leo viverra non
                                    volutpat rhoncus placerat vitae scelerisque. Rhoncus augue faucibus maecenas
                                    lacus...</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="brand-logo">
                <div class="container">
                    <div class="brand-logo_bar">
                        <a href="#" target="_blank">
                            <img src="<?= SITE_TEMPLATE_PATH; ?>/assets/img/InDepthConsultingLogo-UntitledPage.png"
                                 alt="">
                        </a>
                        <a href="#" target="_blank">
            ...
            <div class="container">
                <div class="subscribe__box">
                    <div class="subscribe__text">
                        ...
                        <div class="email">
                            <input class="label-text subscribe__label-text" type="text" placeholder="Your working email"
                                   name="mail" required><input class="subscribe-button subscribe__subscribe-button"
                                                               type="submit" value="Subscribe">
                        </div>
                        <div class="checkbox">
                            <input type="checkbox" id="checked" checked="yes">
                            <label class="icon-box__text_small"> I agree to receive communications from Createx
                                Store. </label>
                        </div>
                    </div>
